...
const PrivacyPolicy = () => {
  return (
    <Container className="py-md-5 py-3">
      ...
      <p>
        It is CMU Undergraduate Entrepreneurship Association’s policy to respect
      ...
      <p>
        ...
        information is protected and maintained. CMU Undergraduate
        Entrepreneurship Association may change this privacy policy from time to
        time at CMU Undergraduate Entrepreneurship Association’s sole
        discretion.
      </p>
    </Container>
  );
