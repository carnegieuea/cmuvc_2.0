...
const Poliies = () => {
  const [policies, showPolicies] = useState(true);
  return (
    <Fragment>
      {policies ? (
        <Container>
          <Row className="py-md-5 py-3">
            <Col>
              <Button
                size="sm"
                color="light"
                onClick={e => showPolicies(!policies)}
              >
                <IoMdRemoveCircleOutline /> Close Applicant Policies
              </Button>
            </Col>
            <Col md="12">
              ...
              <p>
                ...
                VC. Participant's executive summaries and business plans will
                only be seen by the CMU VC planning committee and the judging
                panel. Neither of those documents will be distributed by the
              ...
              <p>
                ...
                we are not able to require audience members to sign
                non-disclosure agreements. Confidentiality has never presented a
                problem in the past, and we don't expect any issues to arise
                from it in the future. Feel free to contact us if you have any
                further questions.
              </p>
            </Col>
          </Row>
          <Row className="py-md-5 py-3">
            <Col md="8">
              ...
              <small>
                * Failure to follow these rules may result in a delayed
                transfer, a limited award, or no reimbursement award at all.
              </small>
              <p className="pt-3">
                ...
                for example, if your team asks for $700 in reimbursements, you
                may receive less than you ask from us. Reimbursements are
                awarded on a case-by-case basis based on the current years'
                budget, reimbursements asked, and legitimacy of request.
              </p>
            </Col>
            <Col md="4">
              ...
              <p>
                <IoIosCheckmarkCircle /> One Individual Responsible for
                Processing
              </p>
              <p>
                <IoIosCheckmarkCircle /> Request must be submitted within 24
                hours of event
              </p>
              <p>
                <IoIosCheckmarkCircle /> Payment transfers are not available
                with Venmo, Paypal, WePay, etc.
              </p>
            </Col>
          </Row>
          <Row className="py-md-5 py-3">
        ...
        <Container className="py-md-5 py-3">
          <Button
            ...
            size="sm"
          >
            Show CMU VC Applicant Policies
          </Button>
        </Container>
      )}
    </Fragment>
